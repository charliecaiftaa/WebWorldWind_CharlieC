 ...
 */
/**
 * @exports CustomizedLayer
 * @version $Id: CustomizedLayer.js 3319 2015-07-15 20:45:54Z dcollins $
 */
define([
        '../error/ArgumentError',
        '../util/Color',
    ...
    function (ArgumentError,
         ...
         */
        var CustomizedLayer = function (worldWindow) {
            if (!worldWindow) {
        ...
        CustomizedLayer.prototype = Object.create(Layer.prototype);

        // Documented in superclass.
        CustomizedLayer.prototype.doRender = function (dc) {
        ...
        // Intentionally not documented.
        CustomizedLayer.prototype.handleUIEvent = function (event) {
        ...
        // Intentionally not documented.
        CustomizedLayer.prototype.handleRedraw = function (stage) {
        ...
        // Intentionally not documented.
        CustomizedLayer.prototype.formatLatitude = function (number) {
            var suffix = number < 0 ? "\u00b0S" : "\u00b0N";
            return Math.abs(number).toFixed(2) + suffix;
        };

        // Intentionally not documented.
        CustomizedLayer.prototype.formatLongitude = function (number) {
            var suffix = number < 0 ? "\u00b0W" : "\u00b0E";
            return Math.abs(number).toFixed(2) + suffix;
        };

        // Intentionally not documented.
        CustomizedLayer.prototype.formatAltitude = function (number, units) {
